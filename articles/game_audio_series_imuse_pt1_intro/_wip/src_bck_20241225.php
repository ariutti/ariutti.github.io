...
<div calss="multi-listen">
  <div>
    <p>Below is a comparison between the three versions of the same track, taken from the soundtrack of '<i>Indiana Jones and the Fate of Atlantis</i>'.</p>
    ...
    <div class="track-container">
      <div class="radio-container">
        <input type="radio" name="track" value="0" onchange="setSolo(0)" checked>MT-32</input>
      </div>
    ...
    <div class="track-container">
      <div class="radio-container">
        <input type="radio" name="track" value="1" onchange="setSolo(1)">OPL2</input>
      </div>
