...
<p>Inside the <b>js</b> folder put the <code>wavesurfer.min.js</code> file. You can do that simply by running the commnad <code>npm install --save wavesurfer.js</code> inside this folder, navigate into the <b>dist</b> subfolder to locate the file, moving it outside and removing everything else.</p>
