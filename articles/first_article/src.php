...
<audio controls="" style="width:100%; margin-bottom: 2ch;"> <source src="sounds/numbers_1to4_every_seconds_48@24_mono.mp3" type="audio/ogg"> </audio>
...
<p>How to deal with images? <br/>
  <?php img("images/laptop.png", 21, "float:left;margin-bottom: 2ch; margin-left: 2ch; margin-right:1ch;");?>
  This is a png image floating to the left.
  <div style="clear:both;"></div>
  <?php img("images/test.gif", 21, "float:right;margin-bottom: 2ch; margin-righ: 2ch; margin-left:1ch;");?>
